...
async def get_data_quality_summary():
    ...
    """
    try:
        from core.data_validation_pipeline import get_validation_pipeline
...
async def get_symbol_quality_metrics(symbol: str):
    ...
    try:
        from core.data_validation_pipeline import get_validation_pipeline
        from core.data_quality_engine import get_data_quality_engine
...
async def get_truth_database_summary():
    ...
    """
    try:
        from core.truth_database import get_truth_database
        
        db = get_truth_database()
...
async def get_event_bus_metrics():
    ...
    """
    try:
        from architecture.event_bus import get_event_bus
