"""
Game-Theory Graph Neural Network (BCF-GCN)
...
if __name__ == "__main__":
    ...
    # Create model
    model = BCFGraphNet(n_features, n_hidden, n_classes=1)
