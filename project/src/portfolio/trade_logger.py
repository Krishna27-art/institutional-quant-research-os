...
class TradeLogger:
    ...
    def _get_db_connection(self):
        try:
            ...
            from config_v3 import config as sys_config
            db_cfg = DatabaseConfig(
                host=sys_config.database.postgres_host,
                port=sys_config.database.postgres_port,
                database=sys_config.database.postgres_database,
                username="postgres",
                password=""
            )
